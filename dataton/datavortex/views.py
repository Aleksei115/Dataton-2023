...
def get_dashboard_data(request):
    ...
    for doc in documentos:
        ...
        while True:
            try:
                escolaridad_data = doc['declaracion']['situacionPatrimonial']['datosCurricularesDeclarante']['escolaridad'][i]
...
# }
    ...
    return JsonResponse({ 'maestria': maestria, 'doctorado': doctorado, 'licenciatura': licenciatura, 'especialidad': especialidad, 'bachillerato': bachillerato, 'primaria': primaria, 'secundaria': secundaria, 'tecnico': tecnico})